package me.jassy.steelmaking.machines;
...
public class Crusher extends BlockBase
{
	...
	public static final PropertyBool CRUSHING = PropertyBool.create("burning");
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			playerIn.openGui(SteelMain.instance, Reference.GUI_CRUSHER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
